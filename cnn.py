...
#W_conv1 = tf.Variable(tf.truncated_normal([5, 5, 3, 32], stddev=2.0/math.sqrt(float(28*28*3))))
...
#W_conv2 = tf.Variable(tf.truncated_normal([5, 5, 32, 64], stddev=2.0/math.sqrt(float(12*12*32))))
...
#W_fc1 = tf.Variable(tf.truncated_normal([4*4*64, 100], stddev=2.0/math.sqrt(float(4*4*64))))
...
#W_fc2 = tf.Variable(tf.truncated_normal([100, 64], stddev=2.0/math.sqrt(float(100))))
b_fc2 = bias_variable([64])
h_fc2 = tf.nn.relu(tf.matmul(h_fc1,W_fc2) + b_fc2)

W_fc3 = weight_variable([64, 2])
#W_fc3 = tf.Variable(tf.truncated_normal([64, 2], stddev=2.0/math.sqrt(float(64))))
...
saver.save(sess,'/tmp/model-cnn3.ckpt')
coord.request_stop()
